...
| **Tool** | A typed function with a JSON schema, available to an agent's LLM. Tools are pluggable: built-in tools (notify, bash, read_file, web_search, web_fetch, write_artifact, read_artifact), MCP-backed tools, and team-defined tools. |
