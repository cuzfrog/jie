...
export const ActionTypes = {
  ...
  MOVE_MCP_CURSOR: "[ui] move mcp cursor",
  TOGGLE_MCP_EXPAND: "[ui] toggle mcp expand",
...
export const Actions = {
  receiveEvent: (event: AnyEventEnvelope) => createAction(ActionTypes.RECEIVE_EVENT, event),
	...
	moveMcpCursor: (direction: 1 | -1) => createAction(ActionTypes.MOVE_MCP_CURSOR, { direction }),
	toggleMcpExpand: () => createAction(ActionTypes.TOGGLE_MCP_EXPAND),
