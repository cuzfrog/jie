...
- Test path fixtures that hardcoded `packages/...` were updated; `src/platform/team/parser.test.ts` points at `../../manifest/teams/default-dev-team` after the consolidation to `src/manifest/`.
