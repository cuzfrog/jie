...
## What you do
- Adhere to @CLAUDE.md.
- Analyze the code and read documents under `doc/specs/`. Suppose you are going to add more features from next stages, think about what makes the code hard to change?
