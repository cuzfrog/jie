...
- Update `./review-tracker.md` for the progress (the tracker is a temporary file). Compact or remove information that has been resolved, we should shift focus on outstanding items.
...
- If no gaps are found, just tell me. Clean up the `./review-tracker.md`.
